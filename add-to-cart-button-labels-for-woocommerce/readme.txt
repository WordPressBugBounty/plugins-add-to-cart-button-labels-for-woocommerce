...
**Change Add to Cart Button Text for WooCommerce** plugin lets you change text for *Add to cart* button.
...
= 2.2.3 - 12/05/2025 =
* Fix - Vulnerability in the `[alg_wc_atcbl_translate]` shortcode.
* Tested up to: 6.8.
* WC tested up to: 9.8.

= 2.2.2 - 02/02/2025 =
* Fix - Missing library files uploaded via Composer.
* WC tested up to: 9.6.
